...
export OTEL_RESOURCE_ATTRIBUTES=service.name=Ranking,service.version=0.0.1-SNAPSHOT

${JAVA_HOME}/bin/java -javaagent:./${AGENT_FILE} -Dfile.encoding=UTF-8 -jar build/libs/Ranking-0.0.1-SNAPSHOT.jar